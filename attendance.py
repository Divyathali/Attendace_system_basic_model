...
message = tk.Label(window, text="DIVI CONFERENCE" ,bg="white"  ,fg="black"  ,width=20  ,height=2,font=('Times New Roman', 25, 'bold')) 
message.place(x=1150, y=760)

message = tk.Label(window, text="ATTENDANCE MANAGEMENT PORTAL" ,bg="lightblue" ,fg="black"  ,width=40  ,height=1,font=('Times New Roman', 35, 'bold underline')) 
message.place(x=200, y=20)

lbl = tk.Label(window, text="Enter Your College ID",width=20  ,height=2  ,fg="black"  ,bg="lightblue" ,font=('Times New Roman', 25, ' bold ') ) 
...
lbl2 = tk.Label(window, text="Enter Your Name",width=20  ,fg="black"  ,bg="lightblue"    ,height=2 ,font=('Times New Roman', 25, ' bold ')) 
...
lbl3 = tk.Label(window, text="NOTIFICATION",width=20  ,fg="black"  ,bg="lightblue"  ,height=2 ,font=('Times New Roman', 25, ' bold ')) 
...
lbl4 = tk.Label(window, text="STEP 1",width=20  ,fg="green"  ,bg="lightblue"  ,height=2 ,font=('Times New Roman', 20, ' bold '))
lbl4.place(x=240-x_cord, y=375-y_cord)

lbl5 = tk.Label(window, text="STEP 2",width=20  ,fg="green"  ,bg="lightblue"  ,height=2 ,font=('Times New Roman', 20, ' bold ')) 
lbl5.place(x=645-x_cord, y=375-y_cord)

lbl6 = tk.Label(window, text="STEP 3",width=20  ,fg="green"  ,bg="lightblue"  ,height=2 ,font=('Times New Roman', 20, ' bold ')) 
...
takeImg = tk.Button(window, text="IMAGE CAPTURE BUTTON", command=TakeImages  ,fg="white"  ,bg="blue"  ,width=25  ,height=2, activebackground = "lightblue" ,font=('Times New Roman', 15, ' bold '))
takeImg.place(x=245-x_cord, y=425-y_cord)
trainImg = tk.Button(window, text="MODEL TRAINING BUTTON", command=TrainImages  ,fg="white"  ,bg="blue"  ,width=25  ,height=2, activebackground = "lightblue" ,font=('Times New Roman', 15, ' bold '))
trainImg.place(x=645-x_cord, y=425-y_cord)
trackImg = tk.Button(window, text="ATTENDANCE MARKING BUTTON", command=TrackImages  ,fg="white"  ,bg="red"  ,width=30  ,height=3, activebackground = "lightblue" ,font=('Times New Roman', 15, ' bold '))
trackImg.place(x=1075-x_cord, y=412-y_cord)
quitWindow = tk.Button(window, text="QUIT", command=quit_window  ,fg="white"  ,bg="red"  ,width=10  ,height=2, activebackground = "lightblue" ,font=('Times New Roman', 15, ' bold '))
